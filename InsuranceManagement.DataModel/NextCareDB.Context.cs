...
namespace InsuranceManagement.DataModel
{
    ...
    public partial class NextCareEntities : DbContext
    {
        public NextCareEntities()
            : base("name=NextCareEntities")
        {
        ...
        public virtual DbSet<HealthCareProviderType> HealthCareProviderTypes { get; set; }
